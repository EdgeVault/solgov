// Attack-telemetry panel surfacing probe activity from the Percolator research stream.
                ...
                {recent.map((e, i) => (
                  <tr key={i} className="border-b border-white/[0.04] last:border-b-0">
                    ...
                    <td className="px-4 py-2.5 text-white font-mono">
                      {e.instructionName}
                      {e.targetsLiveSlab && (
                        <Tooltip text="Transaction references the live SOL/USD slab account.">
                          <span className="ml-2 text-[9px] px-1.5 py-0.5 rounded border border-white/[0.08] bg-white/[0.04] text-gray-400 uppercase tracking-wider">
                            live slab
                          </span>
                        </Tooltip>
                      )}
