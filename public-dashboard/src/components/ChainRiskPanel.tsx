                  ...
                  <td className="px-4 py-2.5 text-right text-gray-300 tabular-nums">
                    <div className="flex items-center justify-end gap-1.5">
                      ...
                      {v.allHacksFullyRecovered && lossRate > 0 && (
                        <span
                          className="text-[9px] px-1.5 py-0.5 rounded border border-white/[0.08] bg-white/[0.04] text-gray-400 uppercase tracking-wider whitespace-nowrap"
                          title="Gross figure; all incidents in this window were fully recovered (net loss to users was zero)"
                        >
                          recovered
                        </span>
                      )}
