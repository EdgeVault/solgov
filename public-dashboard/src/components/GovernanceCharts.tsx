    ...
    <>
      <div className="mb-5">
        ...
        <p className="text-xs text-gray-500">
          Adoption of governance practices across tracked teams. Each chart's historical dates come from on-chain events we can verify for every team.
        </p>
      </div>
      ...
      <div className="mt-6 p-3 rounded-lg border border-white/[0.04] bg-white/[0.01]">
        <p className="text-[11px] text-gray-500">
          Methodology: current counts come from live on-chain reads of each tracked multisig and protocol-issued token. Historical adoption dates come from the earliest on-chain activity we can verify for each multisig. Each chart's ceiling is the number of tracked teams that could express the metric.
        </p>
      </div>
    </>
  );
  ...
  return (
    <div className="mt-6">
      <div className="mb-3">
        ...
        <p className="text-xs text-gray-500">
          Counts across tracked teams and protocol-issued tokens for practices that came into focus after the Drift and Kelp incidents. Each row shows the count and a short description of what the metric measures.
        </p>
      </div>
      <RiskBars bars={bars} />
    </div>
