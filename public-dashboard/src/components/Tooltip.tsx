...
export function Tooltip({ text, children }: { text: string; children: React.ReactNode }) {
  ...
  return (
    <span
      ...
      onClick={(e) => { e.stopPropagation(); e.preventDefault(); updatePos(); setTouched(true); setShow(s => !s); }}
      onTouchEnd={(e) => { e.stopPropagation(); e.preventDefault(); updatePos(); setTouched(true); setShow(s => !s); }}
    >
      {children}
      {show && (
        <span
