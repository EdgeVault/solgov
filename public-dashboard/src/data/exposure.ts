// This file defines the cross-protocol dependency map (oracles, collateral, routing, settlement) used by the Blast Radius view to show how a single multisig compromise can cascade across the ecosystem.
